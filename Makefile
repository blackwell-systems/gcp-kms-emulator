...
# Default target
help:
	@echo "GCP KMS Emulator - Build Targets"
	@echo ""
	@echo "Build commands:"
...
docker-grpc:
	...
	docker build --build-arg VARIANT=grpc -t gcp-kms-emulator:grpc -t gcp-kms-emulator:latest .

docker-rest:
	@echo "Building REST-only Docker image..."
	docker build --build-arg VARIANT=rest -t gcp-kms-emulator:rest .

docker-dual:
	@echo "Building dual-protocol Docker image..."
	docker build --build-arg VARIANT=dual -t gcp-kms-emulator:dual .
